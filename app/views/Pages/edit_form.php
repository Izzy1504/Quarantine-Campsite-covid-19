        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 mt-3 shadow-none border-radius-xl" id="navbarTop">
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                       <!-- đây là đoạn css cho search advance hay còn gọi là modal đã được link -->
                       <?php include "../mod.php"; ?>
                </div>
            </div>
        </nav>
            ...
            <div class="row removable">
                <div class="col-lg-6">
                    ...
                    <div class="patient-info">
                        ...
                        <input type="text" id="address" class="form-control" value="Quảng Trị" placeholder="Quê quán" readonly>
                        ...
                        <label for="symptoms">Nhập viện ở:</label>
                        <input type="text" id="symptoms" class="form-control" value="Camp A, Building A1, Floor 2, Room A121" placeholder="Nhập viện ở" readonly>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="patient-info">
